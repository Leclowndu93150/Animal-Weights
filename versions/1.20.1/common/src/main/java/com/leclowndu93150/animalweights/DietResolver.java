...
public final class DietResolver {
    ...
    public static final TagKey<EntityType<?>> LIVESTOCK = TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation("animalweights", "livestock"));
    ...
    private static TagKey<EntityType<?>> tag(String name) {
        return TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation("animalweights", "diet/" + name));
    }
